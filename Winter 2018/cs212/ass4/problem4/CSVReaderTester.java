...
public class CSVReaderTester
{
   public static void main(String[] args) //throws FileNotFoundException
   {
    ...
    CSVReader reader3 = new CSVReader("test.csv");
   
      System.out.println("att2007.csv");
      ...
      System.out.println("Row 0, Col 3: " + reader3.field(3, 3));
      System.out.println("Expected: \"sixteen\"");
    }
}
